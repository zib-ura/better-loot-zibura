const trek_pillager_mangrove_food = [
...
const trek_pillager_mangrove_tool = [
...
const trek_pillager_mangrove_vine = [
...
//     let LootTableId = "trek:pillagers/outpost_mangrove";
//     if (event.hasLootTable(LootTableId)) {
//         let Loot = event.getLootTable(LootTableId);
//         Loot.clear(); 
//         addCustomLoot(Loot, trek_pillager_mangrove_food, 2, 4);
//         addCustomLoot(Loot, trek_pillager_mangrove_tool, 2, 4);
//         addCustomLoot(Loot, trek_pillager_mangrove_vine, 4, 8);
//     }

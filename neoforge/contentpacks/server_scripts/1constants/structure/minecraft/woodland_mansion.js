const vanilla_woodland_mansion_weapon = [
    {
        groupName: "Combat Gear",
        groupWeight: 30,
        min: 1, max: 1,
        items: [
            { id: 'minecraft:iron_axe', ratio: 10 , enchantChance: 0.0,  damage: [0.7, 0.8] },
            { id: 'minecraft:iron_sword', ratio: 10 , enchantChance: 0.0,  damage: [0.7, 0.8] },
            { id: 'minecraft:crossbow', ratio: 10 , enchantChance: 0.0,  damage: [0.7, 0.8] },
...
const vanilla_woodland_mansion_Treasure = [
    {
        groupName: "treasure",
        groupWeight: 30,
        min: 1, max: 2,
...
const vanilla_woodland_mansion_ore = [
    {
        ...
        max: 3,
        items: [
            { reference: 'lootjs:iron_and_iron_crate', ratio: 10 },
            { reference: 'lootjs:copper_and_copper_crate', ratio: 10 },
            { reference: 'lootjs:gold_and_gold_crate', ratio: 10 },
            { reference: 'lootjs:redstone_and_redstone_crate', ratio: 10 },
            { reference: 'lootjs:lapis_and_lapis_crate', ratio: 10 },
            { reference: 'lootjs:diamond_and_diamond_crate', ratio: 5 },
            { reference: 'lootjs:emerald_and_emerald_crate', ratio: 10 },
            { reference: 'lootjs:quartz_and_quartz_crate', ratio: 10 },
        ]
    },
...
const vanilla_woodland_mansion_music = [
    {
        groupName: "jukebox",
        groupWeight: 25,  
        min: 1,
...
const vanilla_woodland_mansion_music_discs = [
    {
...
const vanilla_woodland_mansion_wools_and_dyes = [
    {
        groupName: "wools",
        groupWeight: 50,
        min: 3, max: 5,
...
const vanilla_woodland_mansion_alcohol = [
    {
        groupName: "alcohol",
        groupWeight: 25,
        min: 1, max: 1,
...
const all_village_house_special_dish = [
    {
        ...
        groupWeight: 10, 
        min: 2, max: 3,
        items: vanilla_village_desert_dish.find(group => group.groupName === "special").items
    },
    {
        groupName: "plains_house_europe",
        groupWeight: 10, 
        min: 2, max: 3,
        items: vanilla_village_plains_dish.find(group => group.groupName === "special europe").items
    },
    {
        groupName: "plains_house_asia",
        groupWeight: 10, 
        min: 2, max: 3,
        items: vanilla_village_plains_dish.find(group => group.groupName === "special asia").items
    },
    {
        groupName: "savanna_house",
        groupWeight: 10, 
        min: 2, max: 3,
        items: vanilla_village_savanna_dish.find(group => group.groupName === "special").items
    },
    {
        groupName: "snowy_house",
        groupWeight: 10, 
        min: 2, max: 3,
        items: vanilla_village_snowy_dish.find(group => group.groupName === "special").items
    },
    // {
...
const woodland_mansion_weapon_content = [
    [vanilla_woodland_mansion_weapon, 16, 20],
];

// 2. treasure
const woodland_mansion_treasure_content = [
    [vanilla_woodland_mansion_Treasure, 2, 4],
    [vanilla_woodland_mansion_ore, 3, 4],
];

// 3. music
const woodland_mansion_music_content = [
    [vanilla_woodland_mansion_music, 4, 6],
    [vanilla_woodland_mansion_music_discs, 3, 5],
];

// 4. wools_and_dyes
const woodland_mansion_wools_and_dyes_content = [
    [vanilla_woodland_mansion_wools_and_dyes, 7, 8],
];

// 5. cuisine
const woodland_mansion_cuisine_content = [
    [all_village_house_special_dish, 6, 7],
    [vanilla_woodland_mansion_alcohol, 2, 3],
];

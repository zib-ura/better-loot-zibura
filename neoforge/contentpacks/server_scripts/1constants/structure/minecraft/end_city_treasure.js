...
const end_city_equipment = [

    {
        ...
        groupWeight: 25,
        min: 1, max: 1, enchantChance: 1, enchantLevels: [20, 40], damage: [0.7, 0.8],
        items: [
...

    {
        ...
        groupWeight: 25,
        min: 1, max: 1, enchantChance: 0.7, enchantLevels: [20, 40], damage: [0.7, 0.8],
        items: [
...

{
        ...
        groupWeight: 25,
        min: 1, max: 1, enchantChance: 0.5, enchantLevels: [20, 40], damage: [0.7, 0.8],
        items: [

const trial_chambers_attack = [
    {
        ...
        groupWeight: 40,
        min: 1, max: 1, enchantChance: 0.5, enchantLevels: [5, 10], damage: [0.7, 0.8],
        items: [
...

    {
        ...
        groupWeight: 20,
        min: 1, max: 1, enchantChance: 0.5, enchantLevels: [5, 10],
        items: [
...

    {
        ...
        groupWeight: 5,
        min: 1, max: 1, enchantChance: 0.7, enchantLevels: [10, 20], damage: [0.7, 0.8],
        items: [
...
const trial_chambers_defense = [
    {
        ...
        groupWeight: 40,
        min: 1, max: 1, enchantChance: 1, enchantLevels: [5, 10], damage: [0.7, 0.8],
        items: [

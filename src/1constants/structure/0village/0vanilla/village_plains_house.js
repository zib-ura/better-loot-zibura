...
const village_plains_base_crops = [
    {
        groupName: "Vanilla & Farmers Delight Crops",
        groupWeight: 90, 
        min: 2, max: 3,
        items: [
...
const village_plains_dish_common_europe = [
...
const village_plains_dish_common_asia = [
    { id: "alexsmobsdelight:turtle_soup", ratio: 10 },
    { id: "alexsmobsdelight:cod_and_turtle_meat_congee", ratio: 10 },
...
const village_plains_dish_special_europe = [
...
const village_plains_dish_special_asia = [

    { id: "alexsmobsdelight:turtle_jelly", ratio: 10 },
    { id: "alexsmobsdelight:catfish_stew", ratio: 10 },
    { id: "alexsmobsdelight:turtle_meat_fried_rice", ratio: 10 },

const vanilla_pillager_outpost_Special = [
    {
...
const vanilla_pillager_outpost_Supplies = [
    // =================================================================
    // GROUP: Food
    // =================================================================
    {
...
const vanilla_pillager_outpost_Treasure = [
    // =================================================================
    // GROUP: treasure
    // =================================================================
    {
...
const vanilla_pillager_outpost_Arrow = [
    {
        groupName: "Arrow",
        groupWeight: 30,
        min: 1, max: 3,
...
const pillager_outpost_content = [
    [vanilla_pillager_outpost_Treasure, 1, 2],
    [vanilla_pillager_outpost_Special, 4, 4],
    [vanilla_pillager_outpost_Supplies, 3, 4],
];

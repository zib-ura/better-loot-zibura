const village_cherry_bakery_cooking_material = [
    {
        ...
        items: [
            ...
            { reference: 'lootjs:honey_and_honey_crate', ratio: 10 },
            ...
            { reference: 'lootjs:redbean_and_redbean_crate', ratio: 10 },
            { reference: 'lootjs:soybean_and_soybean_crate', ratio: 10 },
        ]
    },
...
const village_cherry_bakery_bread = [
    {
        groupName: "bread_base",
        groupWeight: 70,
        min: 1, max: 2,
        items: [
...
const village_cherry_bakery_dessert = [

    {
        groupName: "dessert_cherry",
        groupWeight: 15,
        min: 1, max: 2,
        items: [
...
const village_cherry_house_content = [
    ...
    [village_cherry_bakery_bread, 2, 2],
    [village_cherry_bakery_dessert, 2, 2],
];
